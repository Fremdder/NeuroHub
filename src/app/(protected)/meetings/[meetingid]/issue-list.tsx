...
import {
    ...
    DialogTitle,
    DialogDescription
  } from "@/components/ui/dialog";import { api, type RouterOutputs } from "@/trpc/react"
...
const IssueList = ({meetingId} : Props) =>{
    ...
    return (
        <div>
            <div className="p-8">
                <div className="mx-auto flex max-w-2x1 items-center justify-between gap-x-8 border-b pb-8 lg:mx-0 lg:max-w-none">
                    <div className="flex items-center gap-x-8">
                        ...
                        <h1>
                            ...
                            <div className="mt-1 text-bse font-semibold leading-6 text-gray-900">
                                {meeting.name}
                            </div>
                        </h1>
                    </div>
